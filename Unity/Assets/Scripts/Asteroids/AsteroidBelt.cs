...
public class AsteroidBelt : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        for (int i = 0; i < cubeDensity; i++)
        {
            ...
            _asteroid.AddComponent<Asteroid>().SetupBeltObject(Random.Range(minOrbitSpeed, maxOrbitSpeed), Random.Range(minRotationSpeed, maxRotationSpeed), gameObject, rotatingClockwise);
